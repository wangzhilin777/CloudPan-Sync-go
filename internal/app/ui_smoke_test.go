...
func TestConsoleUISmokeMainline(t *testing.T) {
	...
	runStep(t, runCtx, "status evidence and retry",
		...
		waitForText(`#evidence-summary`, "Execution Mode"),
		waitForText(`#evidence-summary`, "Scan Mode"),
		waitForText(`#evidence-summary`, "Source Delete"),
		...
		setSelectValue(`#provider-smoke-category`, "binary_upload_success"),
		...
		chromedp.SetValue(`#provider-smoke-operations`, "ValidateAuth,List,Metadata,Upload", chromedp.ByID),
